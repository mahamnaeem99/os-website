...
<div class="boxless_video">
    <video autoplay muted loop id="myVideo">
      <source src="./boxless.mp4" type="video/mp4">
    </video>
    </div>
    ...
    <div class="align-items-center boxless-section d-flex flex-column justify-content-center">
      <div class="heading-sec py-5">
        <p class="boxless-heading text-center fs-1">WHAT IS BOXLESS?</p>
      </div>
...
<!-- End Slider -->
  ...
  <div class="container-fluid why-enter-section">
    <div class="py-5">
      ...
      <h1 class="why-enter-heading text-center">REGISTRATIONS <br> ARE CLOSED!</h1>
      <p class="text-center mb-0 form-text">Participation forms will be available on</p>
      <p class="text-center date-text fw-bold">12/05/2022</p>
